...
export default function BursaryPage() {
  ...
  const generateBursaryFormDataURL = () => {
    const formHTML = `<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8"/>
  <title>RUSL – Bursary Application Form</title>
  <style>
...
<body>
  <div class="header-block">
    ...
    <h2>APPLICATION FOR THE BURSARY</h2>
  ...
  <table>
    <tr><th>Name</th><th>Age</th><th>School / University</th><th>Mahapola / Bursary</th></tr>
  ...
  <p style="font-size:10px;color:#666;margin-top:30px;border-top:1px solid #ddd;padding-top:10px;">
    RUSL Smart University System – Bursary Application Form | Rajarata University of Sri Lanka, Mihintale – 50300
  </p>
</body>
</html>`;
